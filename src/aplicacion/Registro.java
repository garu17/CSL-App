...
public class Registro extends JFrame implements MouseListener, ActionListener, FocusListener {
	...
	public void actionPerformed(ActionEvent ae) {
	    // Se crea la variable que guarda qué estás seleccionando
	    ...
	    // Si presionas el botón de Login o presionas enter seleccionando el elemento de contraseña
	        ...
	        if (nombreUsuario.isEmpty() || contraseña.isEmpty() || contraseña2.isEmpty()) {
	            ...
	            JOptionPane.showMessageDialog(null, "Por favor, introduzca datos en todos los campos", "Campos Vacíos",
	                    JOptionPane.ERROR_MESSAGE);
	            return;
	        }

	        // Se hace una búsqueda en la lista de los Usuarios para ver si el nombre está en uso
	        ...
	        // Importa el nuevo usuario a la base de datos
